...
begin
    ...
    begin
        ...
        if Number = 0 then
            ShowMessage('Заказ не был найден')
        else
        begin
            ShowMessage('Заказ найден. Номер заказа: '+IntToStr(Number));
            ComboBox1.Text:='';
            Edit1.Text:='';
            Form7.Close;
        end;
    ...
    begin
        ...
        if Number = 0 then
            ShowMessage('Курьер не был найден')
        else
        begin
            ShowMessage('Курьер найден. Номер курьера: '+IntToStr(Number));
            ComboBox1.Text:='';
            Edit1.Text:='';
            Form7.Close;
        end;
