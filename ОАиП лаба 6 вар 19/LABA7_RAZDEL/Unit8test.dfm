object frmOpen: TfrmOpen
  ...
  object rbOpenMale: TRadioButton
    Left = 8
    Top = 29
    Width = 65
    Height = 17
  ...
  object rbOpenFemale: TRadioButton
    Left = 71
    Top = 29
    Width = 66
    Height = 17
  ...
  object btnOpenType: TButton
    ...
    TabOrder = 3
    OnClick = btnOpenTypeClick
  end
  object btnOpenText: TButton
    Left = 111
    Top = 91
    Width = 97
    Height = 25
